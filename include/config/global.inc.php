 ...
 */
$config['DEBUG'] = 0;
$config['SALT'] = 'PLEASEMAKEMESOMETHINsdgsdgGRANDOM';
$config['SALTY'] = 'THISSHOULDALgrgegsgsSOBERRAANNDDOOM';
...
/**
  ...
  **/
$config['algorithm'] = 'changethisSCRYPT';
...
$config['db']['port'] = 3306;
$config['db']['name'] = 'changethisDBNAME';
// Disabled by default and set in bootstrap if unset, but left in here so
// people know it exists
$config['db']['shared']['accounts'] = 'shared';
$config['db']['shared']['workers'] = 'shared';
$config['db']['shared']['news'] = 'shared';
...
$config['wallet']['host'] = 'CHANGETHISRPClocalhost:changethisRPCPORT';
$config['wallet']['username'] = 'changethisWALLETUSER';
$config['wallet']['password'] = 'changethisWALLETPW';
 ...
 **/
$config['gettingstarted']['coinname'] = 'changethisCOINNAME';
$config['gettingstarted']['coinurl'] = 'http://www.litecoin.org';
$config['gettingstarted']['stratumurl'] = '';
$config['gettingstarted']['stratumport'] = '1111';
 ...
 */
$config['currency'] = 'changethisTICKER';
